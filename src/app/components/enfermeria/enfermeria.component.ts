...
export class EnfermeriaComponent implements OnInit{
  ...
  public citas:Cita[] = [];
  public cita:Cita = new Cita('',new Paciente('','','','',new Date(),'','','','','','','',''),new IUser('','','','','','','','','','','','','','',false,'','','',false,new Sucursal('','','','','','',false)),new Date(),'',new Date(),new Date(),false,[{} as Signos], false,[],'','','',new Date(),new Date(),'',Global.DURACION_CITA,'',false,{} as IUser);
  ...
  updateCita():void{
    ...
    this.cita.horaTomaSignos = new Date();
